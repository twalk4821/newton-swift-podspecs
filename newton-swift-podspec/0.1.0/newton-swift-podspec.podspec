#
#  Be sure to run `pod spec lint newton-swift-podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Tyler Walker" => "tyjohnwalker@gmail.com" }
  # Or just: s.author    = "Tyler Walker"
  # s.authors            = { "Tyler Walker" => "tyjohnwalker@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Tyler Walker"
